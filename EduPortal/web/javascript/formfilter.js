...
{
    var x = document.getElementById("username_login").value;
        if(x=="")
        {
           // stn=stn+"Empty username \n";
...
{
    var x = document.getElementById("password_login").value;
        if(x=="")
        {
           // stn=stn+"Empty password \n";
            document.getElementById("password_login").style.border = "1px solid #FF0000";
            cpassword=false;
        }
        else
        {
